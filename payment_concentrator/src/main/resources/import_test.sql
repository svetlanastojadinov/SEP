...
insert into user (id,username,role_id,password,email,name,surname) values (2,'milan',2,'$2a$10$bVikXYQemT0hIWmBCZWueeixC4zrWFjsEljCWhMFr1pjZofbPDnmS','milan@milan.com','Milan','Milanovic');
...
insert into user (id,username,role_id,password,email,name,surname) values (5,'stefan',3,'$2a$10$7wNWpb9ZVaFwjQ/fWfAX8e.Pw9fSJHPGi3V2nmuhT1kMUtUYNmPsm','stefan@stefan.com','Stefan','Stefanovic');
