...
insert into magazine(title,issn,subscription,user_id,author, price) values ('Filomat',93545180,'READER_PAYS',3,'stefan', 50);
...
insert into article(title,price, user_id, author,magazine_issn) values ('Detekcija mikotoksina putem različitih analitičkih metoda',0.01,4,'pera',14509636);
insert into article(title,price, user_id, author,magazine_issn) values ('Vrednovanje ciljeva upravljanja spomenicima prirode primenom smart i smarter metoda',1,4,'pera',14509636);
