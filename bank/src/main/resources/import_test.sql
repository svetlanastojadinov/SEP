...
insert into client_account(pan,security_code,card_holder_name,expiration_date,available_funds,reserved_funds) values ('4183409876543210','2345','Stefan Stefanovic',{ts '2020-11-29 18:47:52.69'},10000,0);
...
insert into client_account(pan,security_code,card_holder_name,expiration_date,available_funds,reserved_funds) values ('4183403456789012','3456','Jovan Jovanovic',{ts '2020-11-29 18:47:52.69'},10000,0);
...
insert into client_merchant(merchant_id,merchant_password,username,client_account_pan) values ('milan','$2a$10$bVikXYQemT0hIWmBCZWueeixC4zrWFjsEljCWhMFr1pjZofbPDnmS','Milan Milanovic','4381311234567890');
